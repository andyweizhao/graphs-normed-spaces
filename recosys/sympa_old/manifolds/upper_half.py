...
from geoopt.manifolds.siegel.siegel import SiegelManifold
from geoopt.manifolds.siegel.vvd_metrics import SiegelMetricType
from geoopt.manifolds.siegel import csym_math as sm
...
class UpperHalf(SiegelManifold):
    ...
    def random(self, *size, dtype=torch.complex128, device=None, **kwargs) -> torch.Tensor:
